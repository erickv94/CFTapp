...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table ciclo ( idciclo integer not null, ciclo integer, anio date, primary key (idciclo) );");
        ...
        db.execSQL("create table tipotramite ( idtipotramite integer not null, nombrelocal varchar(30) not null, descripcion char(254), primary key (idtipotramite) );");
        ...
        db.execSQL("create table diasnohabiles ( id_dias integer not null, idciclo integer, nombre varchar(10) not null, descripcion char(254), fechasolicitud date, primary key (id_dias), foreign key (idciclo) references ciclo (idciclo) on delete restrict );");
