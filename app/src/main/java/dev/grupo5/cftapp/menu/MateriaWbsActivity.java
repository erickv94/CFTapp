...
public class MateriaWbsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materia_wbs);
        setTitle(R.string.materiawbs);
        submenu = getResources().getStringArray(R.array.submenu);
        activities=getResources().getStringArray(R.array.activitiesMateriawbs);
    ...
    private void clickEventoListView(ListView listViewMain) {
        ...
        listViewMain.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    Class<?> clase= Class.forName("dev.grupo5.cftapp.mantenimientos.Materiawbs."+itemSeleccionado);
