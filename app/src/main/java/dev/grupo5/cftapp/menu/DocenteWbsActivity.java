...
public class DocenteWbsActivity extends AppCompatActivity {
    String[] activities,submenu;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_docente_wbs);
        setTitle(R.string.docentewbs);
        submenu = getResources().getStringArray(R.array.submenu);
        activities=getResources().getStringArray(R.array.activitiesDocentewbs);
    ...
    private void clickEventoListView(ListView listViewMain) {
        ...
        listViewMain.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    Class<?> clase= Class.forName("dev.grupo5.cftapp.mantenimientos.Docentewbs."+itemSeleccionado);
