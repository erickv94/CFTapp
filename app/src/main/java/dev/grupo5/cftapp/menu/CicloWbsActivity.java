...
public class CicloWbsActivity extends AppCompatActivity {
    String [] activities,submenu;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ciclo_wbs);
        setTitle(R.string.ciclowbs);
        submenu = getResources().getStringArray(R.array.submenu);
        activities=getResources().getStringArray(R.array.activitiesCiclowbs);
    ...
    private void clickEventoListView(ListView listViewMain) {
        ...
        listViewMain.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    Class<?> clase= Class.forName("dev.grupo5.cftapp.mantenimientos.Ciclowbs."+itemSeleccionado);
