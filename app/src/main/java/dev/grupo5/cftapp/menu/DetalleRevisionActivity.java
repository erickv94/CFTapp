...
public class DetalleRevisionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_revision);
        setTitle(R.string.detalleRevision);
        submenu = getResources().getStringArray(R.array.submenu);
        activities=getResources().getStringArray(R.array.activitiesDetalleRevision);
        ListView listView= findViewById(R.id.submenu_detalle_revision);
