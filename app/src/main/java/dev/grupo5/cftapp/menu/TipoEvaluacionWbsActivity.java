...
public class TipoEvaluacionWbsActivity extends AppCompatActivity {
    String [] activities,submenu;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tipo_evaluacion_wbs);
        setTitle(R.string.tipoevaluacionwbs);
        submenu = getResources().getStringArray(R.array.submenu);
        activities=getResources().getStringArray(R.array.activitiesTipoEvaluacionwbs);
    ...
    private void clickEventoListView(ListView listViewMain) {
        ...
        listViewMain.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    Class<?> clase= Class.forName("dev.grupo5.cftapp.mantenimientos.TipoEvaluacionwbs."+itemSeleccionado);
