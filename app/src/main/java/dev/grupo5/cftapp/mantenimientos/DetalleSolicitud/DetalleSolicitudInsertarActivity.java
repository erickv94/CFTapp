...
public class DetalleSolicitudInsertarActivity extends AppCompatActivity {
    ...
    private static final int permiso = 69;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.detallesolicitudinsert);
        verificarPermisos();
        //initializing
    ...
    public void verificarPermisos(){
        ...
        if(!Auth.userHasPermission(Auth.guard(this),this,permiso)){
            ...
            Toast.makeText(this,getResources().getString(R.string.no_permisos)+" "
                    +getResources().getString(R.string.detallesolicitudinsert), Toast.LENGTH_LONG).show();
        }

    }

    public void crearDetalleSol(View view){
        ...
        Boolean esRechazado= rechazadoCheck.isChecked();
        ...
        detalleSolicitud.setMotivo(justificacion);
        detalleSolicitud.setEsRechazado(esRechazado);

        String respuesta =detalleSolicitudDB.insertar(detalleSolicitud);
