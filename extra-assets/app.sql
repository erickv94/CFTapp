...
--clean--
create table ciclo ( idciclo integer not null autoincrement, ciclo integer, anio integer, primary key (idciclo) );
...
create table tipotramite ( idtipotramite integer not null, nombre varchar(30) not null, descripcion char(254), primary key (idtipotramite) );
